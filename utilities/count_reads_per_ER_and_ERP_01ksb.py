...
def getOptions():
    ...
    parser = argparse.ArgumentParser(
        description="Count num reads per ERP/ERR using read counts from "
                    ...
                    "Output will include counts per ERP split by sample, "
...
def main():
    ...
    for sample, dfLst in fileDfDct.items():
        ...
        print(f"{sample} counts complete and verified!")
        ...
        allSampleERPCntDf[readNumColLst] = allSampleERPCntDf[readNumColLst].fillna(
            0)
