...
def get_md_cols(name1, name2):
    md_df_cols = ['gene_id','transcript_1','transcript_2','num_junction_T1_only','num_junction_T2_only',
                 ...
                 'flag_3_variation','flag_alt_donor_acceptor','flag_alt_exon','flag_no_shared_nt','num_transcript_in_gene_'+name1,
                 'num_transcript_in_gene_'+name2,'flag_'+name1+'_greater','flag_'+name2+'_greater','flag_match',
                 'transcript_in_gene','min_match_'+name1,'flag_min_match_'+name1,'min_match_'+name2,
                 'flag_min_match_'+name2,'flag_recip_min_match','num_recip_min_match_in_gene',
                 'flag_'+name1+'_tie','flag_'+name2+'_tie','flag_identical_recip_min_match','flag_FSM_recip_min_match',
                 ...
                 'flag_no_shared_nt_recip_min_match','flag_alt_exon_recip_min_match','flag_alt_donor_acceptor_recip_min_match',
...
def identify_min_pair(td_data, out_pairs, name1, name2):
    ...
    td_data['flag_no_shared_nt_recip_min_match'] = np.where((td_data['flag_recip_min_match']==1)&
                                                               (td_data['flag_no_shared_nt']==1),1,0)
