...
def get_md_cols(name1, name2):
    md_df_cols = [
            ...
            'flag_alt_exon'
            'flag_no_shared_nt'
            'num_transcript_in_gene_mel_ref'
            'num_transcript_in_gene_mel_mapped'
            'flag_mel_ref_greater'
            'flag_mel_mapped_greater'
            'flag_match'
            'transcript_in_gene'
            'min_match_mel_ref'
            'flag_min_match_mel_ref'
            'min_match_mel_mapped'
            'flag_min_match_mel_mapped'
            'flag_recip_min_match'
            'num_recip_min_match_in_gene'
            'flag_mel_ref_tie'
            'flag_mel_mapped_tie'
            'mel_ref_distance_ties'
            'mel_mapped_distance_ties'
            ...
            'flag_min_match_mel_ref_w_ties'
            'flag_min_match_mel_mapped_w_ties'
